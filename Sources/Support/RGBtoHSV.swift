...
public struct RGB {
    ...
    public var sRGB: UInt32 {
        let r: UInt32 = UInt32(255.0*self.r) << 16
        let g: UInt32 = UInt32(255.0*self.g) << 8
        let b: UInt32 = UInt32(255.0*self.b)
        return UInt32(0xFF000000 + r + g + b)
    }
}
...
public struct HSV {
    ...
    public static func rgb(h: Float, s: Float, v: Float) -> RGB {
    ...
    public static func rgb(hsv: HSV) -> RGB {
