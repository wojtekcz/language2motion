...
for runNum in 0..<runsSettings.count {
   ...
   var model = try! LangMotionTransformer(checkpoint: logdirURL.appendingPathComponent("run_set_48/checkpoints"), config: config, name: "run_1_lr_1e-05.e42")
