...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "MotionLangModels", dependencies: ["Datasets", "TextModels", "ModelSupport", "ImageClassificationModels", "TranslationModels", "TrainingLoop"], path: "Sources/Models/MotionLang"),
