...
public struct MotionLangBatch: KeyPathIterable {
    ...
    public init(motionFrames: Tensor<Float>, motionFlag: Tensor<Int32>,  origMotionFramesCount: Tensor<Int32>, targetTokenIds: Tensor<Int32>, targetMask: Tensor<Float>, targetTruth: Tensor<Int32>) {
        self.motionFrames = motionFrames
        self.motionFlag = motionFlag
        self.origMotionFramesCount = origMotionFramesCount
